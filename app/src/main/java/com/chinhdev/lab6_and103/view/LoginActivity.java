...
import com.chinhdev.lab6_and103.databinding.ActivityLoginBinding;
    ...
    private void userListener() {
        binding.btLogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                User user = new User();
                String _username = binding.edEmailLogin.getText().toString().trim();
                String _password = binding.edPasswordLogin.getText().toString().trim();
